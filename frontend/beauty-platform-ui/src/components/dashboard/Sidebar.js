...
function NavBtn({ icon, label, active, collapsed, onClick, disabled, title }) {
  return (
    <button
      onClick={onClick}
      disabled={disabled}
...
export default function Sidebar({ collapsed, onToggle }) {
  ...
  const sectionLabel = (text) => !collapsed && (
    <span style={{
      ...
      color: accent, textTransform: 'uppercase', letterSpacing: '0.8px',
        ...
        {!collapsed && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, overflow: 'hidden' }}>
            ...
            <div style={{ overflow: 'hidden' }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#1E293B', whiteSpace: 'nowrap' }}>Beauty Platform</div>
