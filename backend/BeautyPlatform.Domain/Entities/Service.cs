...
namespace CRMService.Domain.Entities
{
    public class Service
    {
        ...
        /// <summary>Скільки часу блокується у розкладі (включає підготовку майстра)</summary>
        public int SystemDurationMinutes { get; private set; }

        /// <summary>Скільки часу показується клієнту при бронюванні</summary>
        ...
        public void AddImage(string imageUrl, bool isCover = false)
        {
            ...
            // Якщо це перша або cover — знімаємо cover з інших
            if (isCover)
            {
            ...
            // Якщо зображень немає — перше автоматично cover
        ...
        public void RemoveImage(Guid imageId)
        {
            ...
            // Якщо видалили cover — першу з решти робимо cover
