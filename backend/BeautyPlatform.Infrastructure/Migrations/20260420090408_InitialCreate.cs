        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    SpecializationCategoryId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Services_SpecializationCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "SpecializationCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemDurationOverride = table.Column<int>(type: "integer", nullable: true),
                    ClientDurationOverride = table.Column<int>(type: "integer", nullable: true),
                    AssignedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_EmployeeId_StartTimeUtc_Status",
                table: "Bookings",
                columns: new[] { "EmployeeId", "StartTimeUtc", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_SalonId_StartTimeUtc",
                table: "Bookings",
                columns: new[] { "SalonId", "StartTimeUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeBreaks_EmployeeId_Date",
